...
@Component({
  ...
  template: `
    <div class="align-middle py-2 px-4  border border-secondary ">
      ...
      <h3 class="heading-colors text-center text-darkblue ff-source-serif-semi-bold border-heading">{{ 'stateCoordinatorsTitle' | translate }}</h3>
...
export class StateCoordinatorsComponent implements OnInit {
  data: {
    designation: string;
    name: string;
    phoneNo: string;
