  ...
  template: `
    <div class="content_topgape container py-2 px-4 border-secondary">
      <div class="col text-grey-blue">
        <p>
        The Sri Sathya Sai Mission of education presents a distinctive model of schooling and higher education: one that sees the formation of character, service-oriented living, spiritual awareness and academic competence as inter-linked and indispensable. <b>By embedding value-education (Educare) in the heart of the system, the mission offers an alternative to purely utilitarian approaches to education.</b>
        </p>
        <p>
